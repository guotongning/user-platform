...
<body>
<div class="container">
    <form id="user-register-form" class="form-signin" enctype="application/x-www-form-urlencoded" method="post" action="/user/register">
        <h1 class="h3 mb-3 font-weight-normal">注册</h1>
        <label for="inputEmail" class="sr-only">请输出电子邮件</label>
        <input type="text" id="inputName" name="name" class="form-control" placeholder="请输入用户名称" required autofocus>
        <label for="inputEmail" class="sr-only">请输出电子邮件</label>
        <input type="text" id="inputPhoneNumber" name="phoneNumber" class="form-control" placeholder="请输入手机号" required autofocus>
        <label for="inputEmail" class="sr-only">请输出电子邮件</label>
